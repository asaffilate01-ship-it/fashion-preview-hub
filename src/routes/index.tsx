...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Kalethon — Poise in Motion | Premium Sport Essentials" },
      { name: "description", content: "Kalethon: elevated tennis, golf, padel and off-court essentials from London, with an AI virtual fitting room powered by FASHN." },
      { property: "og:title", content: "Kalethon — Poise in Motion" },
      { property: "og:description", content: "Elevated sport essentials and a private AI virtual fitting room." },
    ...
    <main>
        ...
        <div className="piece-grid" id="all-pieces">
          {pieces.map((piece, index) => (
            <article className={`piece-card tone-${piece.tone}`} key={piece.name}>
              ...
              <a className="piece-try-link" href="#try-on">Try it on <Arrow /></a>
            </article>
          ))}
        </div>
      </section>
      ...
      <footer>
        ...
        <div className="footer-links">
          <div><p>Shop</p><a href="#collections">Sport collections</a><a href="#hoodies">Hoodies</a><a href="#tennis">Tennis</a><a href="#golf">Golf</a><a href="#padel">Padel</a><a href="#pickleball">Pickleball / USA</a><a href="#casual">Casual</a></div>
          <div><p>Kalëthon</p><a href="#story">Our standard</a><a href="#story">Materials</a><a href="#story">Care</a></div>
          <div><p>Client service</p><a href="mailto:concierge@kalethon.com">Contact</a><a href="#pieces">Delivery & returns</a><a href="#pieces">Size guide</a></div>
        </div>
